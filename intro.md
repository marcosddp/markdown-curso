markdown es un formato que no permite generar archivos html y xml.
Con una sintaxis facil entender y sencilla.

sirve para escribir blogs,publicaciones,github,etc.
